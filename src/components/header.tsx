...
export default function Header() {
  return (
    <div className="flex flex-row items-center justify-between px-160 py-16 bg-gradient-surface border-b-gradient-surface">
      ...
      <button className="bg-surface px-16 py-10 rounded-8 transition-opacity active:opacity-70 text-text font-pretendard-semibold text-16 cursor-pointer">로그인</button>
    </div>
  );
}
